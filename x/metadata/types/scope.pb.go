...
type NetAssetValue struct {
	...
	// Deprecated: Prefer to use `volume_int` instead. volume is the number of scope instances that were purchased for
	// the price. It cannot represent volumes larger than the max uint64; use volume_int for those.
	Volume uint64 `protobuf:"varint,3,opt,name=volume,proto3" json:"volume,omitempty"` // Deprecated: Do not use.
	// volume_int is the number of scope instances that were purchased for the price. It is the 256-bit replacement for
	// the deprecated volume field and is the authoritative value when set. Typically this is one; the only reason it
	// would be more than one is when the precision of the price denom is insufficient to represent the actual price.
...
var fileDescriptor_edeea634bfb18aba = []byte{
	...
	,
}
