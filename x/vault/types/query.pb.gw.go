...
var (
	pattern_Query_Vaults_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"provenance", "vault", "v1", "vaults"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Vault_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"provenance", "vault", "v1", "vaults", "vault_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TotalAssets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"provenance", "vault", "v1", "vaults", "vault_address", "total_assets"}, "", runtime.AssumeColonVerbOpt(false)))
)
